...
android {
    namespace = "com.checkscam.app"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.checkscam.app"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0.0"
...
dependencies {
    implementation(project(":call-detection"))
    implementation(project(":audio-capture"))
    implementation(project(":stt-engine"))
    implementation(project(":diarization"))
    implementation(project(":scam-classifier"))
